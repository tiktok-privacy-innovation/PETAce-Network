...
macro(network_combine_archives target dependency)
    if(MSVC)
...
macro(network_fetch_thirdparty_content content_file)
    set(NETWORK_FETCHCONTENT_BASE_DIR_OLD ${FETCHCONTENT_BASE_DIR})
    set(FETCHCONTENT_BASE_DIR ${NETWORK_THIRDPARTY_DIR} CACHE STRING "" FORCE)
    include(${content_file})
    set(FETCHCONTENT_BASE_DIR ${NETWORK_FETCHCONTENT_BASE_DIR_OLD} CACHE STRING "" FORCE)
    unset(NETWORK_FETCHCONTENT_BASE_DIR_OLD)
endmacro()
